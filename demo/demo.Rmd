...
The average weight of a penguin is `r cloze(round(mean(penguins$body_mass_g, na.rm = TRUE), 2), tolerance = 1)`, which is slightly more than the median weight of `r median(penguins$body_mass_g, na.rm = TRUE)`.
